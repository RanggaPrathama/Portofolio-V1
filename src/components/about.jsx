    ...
    return(
        <div className="container relative w-full mx-auto mt-24 max-w-[1200px] ">
            <div className="container mx-auto">
                ...
                <h1 className="font-black text-white lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2">About Me</h1>
            ...
            <div className="flex flex-wrap gap-5 mt-20 align-center ">
               {contentServiceCard.map((item,index)=>(
                <CardService key={item.title} index={index} {...item} />
               ))}
            </div>
        </div>
    )
